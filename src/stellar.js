 ...
 *
 * Argument m is apparent magnitude, gp is annual parallax in arc seconds.
 */
M.absoluteByParallax = function (m, gp) { // (m, gp float64)  float64
  return m + 5 + 5 * Math.log10(gp)
}
