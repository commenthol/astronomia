 ...
 * conjunction.
 */
M.planetary = function (t1, t5, r1, d1, r2, d2) { // (t1, t5 float64, r1, d1, r2, d2 []float64)  (t, Δd float64, err error)
 ...
 */
M.stellar = function (t1, t5, r1, d1, r2, d2) { // (t1, t5, r1, d1 float64, r2, d2 []float64)  (t, Δd float64, err error)
