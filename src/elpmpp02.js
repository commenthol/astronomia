...
const DIST_FACTOR = 1;//384747.961370173 / 384747.980674318;
...
const CSa = [dms(50, 04, 38.902495), 4399609.33632 * SEC2RAD];
const CUr = [dms(314, 03, 4.354234), 1542482.57845 * SEC2RAD];
...
export class ElpMpp {
  ...
  positionXYZ(jde) {
    ...
    let W2 = horner(T, CW2);
    let W3 = horner(T, CW3);
    let Earth = horner(T, CEarth);
    let Peri = horner(T, CPeri);
