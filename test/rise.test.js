...
describe('#rise', function () {
  ...
  describe('methods', function () {
    ...
    it('approxTimes', function () {
      ...
      var rs = rise.approxTimes(p, h0, Th0, ga, gd)
    ...
    it('times', function () {
      ...
      // Meeus gives us the value of 11h 50m 58.1s but we have a package function for this:
      var Th0 = sidereal.apparent0UT(jd)
      // Similarly as with Th0, Meeus gives us the value of 56 for gDT but
      // let's use our package function.
      var gDT = deltat.deltaT(new julian.Calendar().fromJD(jd).toYear())
      var rs = rise.times(p, gDT, h0, Th0, ga3, gd3)
      // v1 api
