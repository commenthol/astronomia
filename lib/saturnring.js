 ...
 */
var InnerEdgeOfOuter = 0.8801;
var OuterEdgeOfInner = 0.8599;
var InnerEdgeOfInner = 0.6650;
var InnerEdgeOfDusky = 0.5486;
...
M.ub = function (jde, earth, saturn) {
  ...
  var _cl4 = _slicedToArray(_cl3, 2);

  var f1 = _cl4[0];
  var f2 = _cl4[1]; // eslint-disable-line no-unused-vars
...
function cl(jde, earth, saturn) {
  ...
  var f1 = function f1() {
    ...
    var sλΩ = _base$sincos8[0];
    var cλΩ = _base$sincos8[1];
  ...
  var f2 = function f2() {
    ...
    var sl0λ = _base$sincos10[0];
    var cl0λ = _base$sincos10[1];
    ...
    var sδ0 = _base$sincos12[0];
    var cδ0 = _base$sincos12[1];
    ...
    var sα0α = _base$sincos16[0];
    var cα0α = _base$sincos16[1];
