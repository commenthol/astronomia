...
M.positions = function (jde) {
  ...
  var sK = _base$sincos10[0];
  var cK = _base$sincos10[1];
  ...
  var xy = function xy(u, r) {
    ...
    var su = _base$sincos20[0];
    var cu = _base$sincos20[1];
...
M.e5 = function (jde, earth, jupiter, pos) {
  // (jde float64, earth, jupiter *pp.V87Planet, pos *[4]XY)
  ...
  var Δ = 5.0;(function () {
    ...
    var ss = _base$sincos22[0];
    var cs = _base$sincos22[1];
    ...
    var f = function f() {
      ...
      var lon = _jupiter$position.lon;
      var lat = _jupiter$position.lat;
      var range = _jupiter$position.range;

      var _base$sincos23 = base.sincos(lon);

      var _base$sincos24 = _slicedToArray(_base$sincos23, 2);

      var sl = _base$sincos24[0];
      var cl = _base$sincos24[1];

      var _base$sincos25 = base.sincos(lat);

      var _base$sincos26 = _slicedToArray(_base$sincos25, 2);

      var sb = _base$sincos26[0];
      var cb = _base$sincos26[1];
  ...
  var R;(function () {
    var L = [L1, L2, L3, L4];
    var B = [Math.atan(0.0006393 * p * Math.sin(L1 - ω1) + 0.0001825 * p * Math.sin(L1 - ω2) + 0.0000329 * p * Math.sin(L1 - ω3) + -0.0000311 * p * Math.sin(L1 - ψ) + 0.0000093 * p * Math.sin(L1 - ω4) + 0.0000075 * p * Math.sin(3 * L1 - 4 * l2 - 1.9927 * Σ1 + ω2) + 0.0000046 * p * Math.sin(L1 + ψ - 2 * Π - 2 * G)), Math.atan(0.0081004 * p * Math.sin(L2 - ω2) + 0.0004512 * p * Math.sin(L2 - ω3) + -0.0003284 * p * Math.sin(L2 - ψ) + 0.0001160 * p * Math.sin(L2 - ω4) + 0.0000272 * p * Math.sin(l1 - 2 * l3 + 1.0146 * Σ2 + ω2) + -0.0000144 * p * Math.sin(L2 - ω1) + 0.0000143 * p * Math.sin(L2 + ψ - 2 * Π - 2 * G) + 0.0000035 * p * Math.sin(L2 - ψ + G) + -0.0000028 * p * Math.sin(l1 - 2 * l3 + 1.0146 * Σ2 + ω3)), Math.atan(0.0032402 * p * Math.sin(L3 - ω3) + -0.0016911 * p * Math.sin(L3 - ψ) + 0.0006847 * p * Math.sin(L3 - ω4) + -0.0002797 * p * Math.sin(L3 - ω2) + 0.0000321 * p * Math.sin(L3 + ψ - 2 * Π - 2 * G) + 0.0000051 * p * Math.sin(L3 - ψ + G) + -0.0000045 * p * Math.sin(L3 - ψ - G) + -0.0000045 * p * Math.sin(L3 + ψ - 2 * Π) + 0.0000037 * p * Math.sin(L3 + ψ - 2 * Π - 3 * G) + 0.000003 * p * Math.sin(2 * l2 - 3 * L3 + 4.03 * Σ3 + ω2) + -0.0000021 * p * Math.sin(2 * l2 - 3 * L3 + 4.03 * Σ3 + ω3)), Math.atan(-0.0076579 * p * Math.sin(L4 - ψ) + 0.0044134 * p * Math.sin(L4 - ω4) + -0.0005112 * p * Math.sin(L4 - ω3) + 0.0000773 * p * Math.sin(L4 + ψ - 2 * Π - 2 * G) + 0.0000104 * p * Math.sin(L4 - ψ + G) + -0.0000102 * p * Math.sin(L4 - ψ - G) + 0.0000088 * p * Math.sin(L4 + ψ - 2 * Π - 3 * G) + -0.0000038 * p * Math.sin(L4 + ψ - 2 * Π - G))];
    ...
    for (i in L) {
      ...
      var sLψ = _base$sincos28[0];
      var cLψ = _base$sincos28[1];

      var _base$sincos29 = base.sincos(B[i]);

      var _base$sincos30 = _slicedToArray(_base$sincos29, 2);

      var sB = _base$sincos30[0];
      var cB = _base$sincos30[1];
  ...
  var sI = _base$sincos32[0];
  var cI = _base$sincos32[1];
  ...
  var sΩ = _base$sincos34[0];
  var cΩ = _base$sincos34[1];

  var _base$sincos35 = base.sincos(ψ - Ω);

  var _base$sincos36 = _slicedToArray(_base$sincos35, 2);

  var sΦ = _base$sincos36[0];
  var cΦ = _base$sincos36[1];
  ...
  var sD = _base$sincos44[0];
  var cD = _base$sincos44[1];
  // p. 313
