...
M.radius = function (T) {
  ...
  var lon = _M$true.lon;
  var ano = _M$true.ano; // eslint-disable-line
...
M.apparentLongitude = function (T) {
  ...
  var lon = _M$true2.lon;
  var ano = _M$true2.ano; // eslint-disable-line
...
M.true2000 = function (T) {
  ...
  var lon = _M$true3.lon;
  var ano = _M$true3.ano;
...
M.trueEquatorial = function (jde) {
  ...
  var lon = _M$true4.lon;
  var ano = _M$true4.ano; // eslint-disable-line
  ...
  var sε = _base$sincos4[0];
  var cε = _base$sincos4[1];
  // (25.6, 25.7) p. 165
...
M.apparentEquatorial = function (jde) {
  ...
  var sε = _base$sincos8[0];
  var cε = _base$sincos8[1];
...
M.trueVSOP87 = function (planet, jde) {
  ...
  var lon = _planet$position.lon;
  var lat = _planet$position.lat;
  var range = _planet$position.range;
  ...
  var sλp = _base$sincos10[0];
  var cλp = _base$sincos10[1];
...
M.apparentVSOP87 = function (planet, jde) {
  ...
  var lon = _M$trueVSOP.lon;
  var lat = _M$trueVSOP.lat;
  var range = _M$trueVSOP.range;
  ...
  var _ = _nutation$nutation2[1]; // eslint-disable-line
...
M.apparentEquatorialVSOP87 = function (planet, jde) {
  ...
  var lon = _M$trueVSOP2.lon;
  var lat = _M$trueVSOP2.lat;
  var range = _M$trueVSOP2.range;

  var _nutation$nutation3 = nutation.nutation(jde);

  var _nutation$nutation4 = _slicedToArray(_nutation$nutation3, 2);

  var Δψ = _nutation$nutation4[0];
  var Δε = _nutation$nutation4[1];
  ...
  var ra = _toEquatorial.ra;
  var dec = _toEquatorial.dec;

  return { ra: ra, dec: dec, range: range };
};
