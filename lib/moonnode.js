...
function node(y, h) {
  ...
  var gw = base.horner(T, 123.9767 * p, -1.44098956 * p / ck, 0.0020608 * p, 0.00000214 * p, -0.000000016 * p);
  var V = base.horner(T, 299.75 * p, 132.85 * p, -0.009173 * p);
  var P = gw + 272.75 * p - 2.3 * p * T;
