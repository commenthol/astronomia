...
M.physical = function (jde, earth, jupiter) {
  ...
  var sδs = _base$sincos14[0];
  var cδs = _base$sincos14[1];

  var _base$sincos15 = base.sincos(δ0);

  var _base$sincos16 = _slicedToArray(_base$sincos15, 2);

  var sδ0 = _base$sincos16[0];
  var cδ0 = _base$sincos16[1];
  ...
  var sε = _base$sincos22[0];
  var cε = _base$sincos22[1];

  var _base$sincos23 = base.sincos(α);

  var _base$sincos24 = _slicedToArray(_base$sincos23, 2);

  var sα = _base$sincos24[0];
  var cα = _base$sincos24[1];
  ...
  var sα0 = _base$sincos26[0];
  var cα0 = _base$sincos26[1];
  ...
  var sδ0ʹ = _base$sincos30[0];
  var cδ0ʹ = _base$sincos30[1];

  var _base$sincos31 = base.sincos(α0ʹ - αʹ);

  var _base$sincos32 = _slicedToArray(_base$sincos31, 2);

  var sα0ʹαʹ = _base$sincos32[0];
  var cα0ʹαʹ = _base$sincos32[1];
  // (42.4) p. 290
...
M.physical2 = function (jde) {
  ...
  var sK = _base$sincos42[0];
  var cK = _base$sincos42[1];
