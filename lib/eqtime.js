...
M.e = function (jde, earth) {
  var gt = base.J2000Century(jde) * 0.1;
  var L0 = l0(gt);
  ...
  var eq = new coord.Ecliptic(gl, lat).toEquatorial(ge);
  // (28.1) p. 183
  var E = L0 - 0.0057183 * Math.PI / 180 - eq.ra + gDgps * cos(ge);
 ...
 * (28.2) p. 183
 */
var l0 = function l0(gt) {
  return base.horner(gt, 280.4664567, 360007.6982779, 0.03032028, 1.0 / 49931, -1.0 / 15300, -1.0 / 2000000) * Math.PI / 180;
};
