 ...
 *  Argument of Perihelion, gwa = Peri - Node
 *
 ...
 * @param {Number} peri - longitude of perihelion, ϖ (Meeus likes gp better)
 */
...
var cMean = {
  mercury: { // Mercury
    ...
    gw: [48.330893, 1.1861883, 0.00017542, 0.000000215],
  ...
  venus: { // Venus
    ...
    gw: [76.67992, 0.9011206, 0.00040618, -0.000000093],
  ...
  mars: { // Mars
    ...
    gw: [49.558093, 0.7720959, 0.00001557, 0.000002267],
  ...
  jupiter: { // Jupiter
    ...
    gw: [100.464407, 1.0209774, 0.00040315, 0.000000404],
  ...
  saturn: { // Saturn
    ...
    gw: [113.665503, 0.877088, -0.00012176, -0.000002249],
  ...
  uranus: { // Uranus
    ...
    gw: [74.005957, 0.5211278, 0.00133947, 0.000018484],
  ...
  neptune: { // Neptune
    ...
    gw: [131.784057, 1.1022039, 0.00025952, -0.000000637],
...
M.mean = function (p, jde, e) {
  ...
  e.node = base.horner(T, c.gw) * Math.PI / 180;
 ...
 * radians, referenced to mean dynamical ecliptic and equinox of date.
 */
M.node = function (p, jde) {
  // (p int, jde float64)  float64
  return base.horner(base.J2000Century(jde), cMean[p].gw) * Math.PI / 180;
};