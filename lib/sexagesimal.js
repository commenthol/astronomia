  ...
  */
  ...
  _createClass(Angle, [{
    ...
    value: function setDMS() {
      var neg = arguments.length <= 0 || arguments[0] === undefined ? 0 : arguments[0];
      var d = arguments.length <= 1 || arguments[1] === undefined ? 0 : arguments[1];
      var m = arguments.length <= 2 || arguments[2] === undefined ? 0 : arguments[2];
      var s = arguments.length <= 3 || arguments[3] === undefined ? 0.0 : arguments[3];
    ...
    value: function toString(precision) {
      var _M$degToDMS = M.degToDMS(this.deg());

      var _M$degToDMS2 = _slicedToArray(_M$degToDMS, 4);

      var neg = _M$degToDMS2[0];
      var d = _M$degToDMS2[1];
      var m = _M$degToDMS2[2];
      var s = _M$degToDMS2[3];
    ...
    value: function toDegString(precision) {
      ...
      var _Modf2 = _slicedToArray(_Modf, 2);
...
var HourAngle = function (_Angle) {
  ...
  function HourAngle() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(HourAngle).apply(this, arguments));
  }
  ...
  _createClass(HourAngle, [{
    ...
    */
    ...
    key: 'toString',
    value: function toString(precision) {
      var _M$degToDMS3 = M.degToDMS(this.deg());

      var _M$degToDMS4 = _slicedToArray(_M$degToDMS3, 4);

      var neg = _M$degToDMS4[0];
      var h = _M$degToDMS4[1];
      var m = _M$degToDMS4[2];
      var s = _M$degToDMS4[3];
...
M.degToDMS = function (deg) {
  ...
  var _Modf4 = _slicedToArray(_Modf3, 2);
  ...
  var _Modf6 = _slicedToArray(_Modf5, 2);
...
var RA = function (_HourAngle) {
  ...
  function RA() {
    ...
    var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(RA).call(this));
...
var Time = function () {
  ...
  _createClass(Time, [{
    ...
    value: function setHMS() {
      var neg = arguments.length <= 0 || arguments[0] === undefined ? false : arguments[0];
      var h = arguments.length <= 1 || arguments[1] === undefined ? 0 : arguments[1];
      var m = arguments.length <= 2 || arguments[2] === undefined ? 0 : arguments[2];
    ...
    value: function toString(precision) {
      ...
      var _toHMS2 = _slicedToArray(_toHMS, 4);
      ...
      var _Modf8 = _slicedToArray(_Modf7, 2);
