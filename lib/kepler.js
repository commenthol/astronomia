...
M.kepler2 = function (e, M, places) {
  ...
  var f = function f(E0) {
    ...
    var se = _base$sincos2[0];
    var ce = _base$sincos2[1];
...
M.kepler2a = function (e, M, places) {
  ...
  var f = function f(E0) {
    ...
    var se = _base$sincos4[0];
    var ce = _base$sincos4[1];
...
M.kepler2b = function (e, M, places) {
  ...
  var f = function f(E0) {
    ...
    var se = _base$sincos6[0];
    var ce = _base$sincos6[1];
...
M.kepler4 = function (e, M) {
  ...
  var sm = _base$sincos8[0];
  var cm = _base$sincos8[1];
