...
M.position = function (earth, jde) {
  ...
  var ss = _base$sincos4[0];
  var cs = _base$sincos4[1];
...
M.xyz = function (earth, jde) {
  ...
  var lon = _earth$position.lon;
  var lat = _earth$position.lat;
  var range = _earth$position.range;
  ...
  var ss = _base$sincos6[0];
  var cs = _base$sincos6[1];
