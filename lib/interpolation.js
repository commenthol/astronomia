...
var Len5 = function () {
  ...
  _createClass(Len5, [{
    ...
    value: function extremum() {
      ...
      var _iterate4 = _slicedToArray(_iterate3, 2);
    ...
    value: function zero(strong) {
      ...
      if (strong) {
        (function () {
          // (3.11), p. 29
          var M = _this2.k / 24;
          var N = (_this2.h + _this2.j) / 12;
          var P = _this2.f / 2 - M;
          var Q = (_this2.b + _this2.c) / 2 - N;
          var numCoeff = [_this2.y3, Q, P, N, M];
        ...
        (function () {
          // (3.10), p. 29
          var numCoeff = [-24 * _this2.y3, 0, _this2.k - 12 * _this2.f, -2 * (_this2.h + _this2.j), -_this2.k];
          var den = 12 * (_this2.b + _this2.c) - 2 * (_this2.h + _this2.j);
          f = function f(n0) {
            return base.horner.apply(base, [n0].concat(numCoeff)) / den;
          };
        })();
      }
      ...
      var _iterate6 = _slicedToArray(_iterate5, 2);
