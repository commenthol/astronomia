...
var DAYSOFYEAR = [0, 0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334];
...
var Calendar = function () {
  ...
  _createClass(Calendar, [{
    ...
    value: function getTime() {
      ...
      var _t$toHMS2 = _slicedToArray(_t$toHMS, 4);

      var neg = _t$toHMS2[0];
      var h = _t$toHMS2[1];
      var m = _t$toHMS2[2];
      var _s = _t$toHMS2[3]; // eslint-disable-line no-unused-vars

      var _base$modf = base.modf(_s);

      var _base$modf2 = _slicedToArray(_base$modf, 2);

      var s = _base$modf2[0];
      var ms = _base$modf2[1];
    ...
    value: function toISOString() {
      ...
      var year = _getDate.year;
      var month = _getDate.month;
      var day = _getDate.day;
      ...
      var millisecond = _getTime.millisecond;
    ...
    value: function toDate() {
      ...
      var _base$modf4 = _slicedToArray(_base$modf3, 2);

      var day = _base$modf4[0];
      var fhour = _base$modf4[1];

      var _base$modf5 = base.modf(fhour * 24);

      var _base$modf6 = _slicedToArray(_base$modf5, 2);

      var hour = _base$modf6[0];
      var fminute = _base$modf6[1];

      var _base$modf7 = base.modf(fminute * 60);

      var _base$modf8 = _slicedToArray(_base$modf7, 2);

      var minute = _base$modf8[0];
      var fsecond = _base$modf8[1];

      var _base$modf9 = base.modf(fsecond * 60);

      var _base$modf10 = _slicedToArray(_base$modf9, 2);

      var second = _base$modf10[0];
      var fms = _base$modf10[1];
    ...
    value: function toYear() {
      ...
      var _base$modf12 = _slicedToArray(_base$modf11, 2);

      var d = _base$modf12[0];
      var f = _base$modf12[1]; // eslint-disable-line no-unused-vars

      var n = this.dayOfYear() + f - 1;
    ...
    value: function fromJD(jd) {
      ...
      var year = _M$JDToCalendar.year;
      var month = _M$JDToCalendar.month;
      var day = _M$JDToCalendar.day;
...
var CalendarJulian = function (_Calendar) {
  ...
  function CalendarJulian() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(CalendarJulian).apply(this, arguments));
  }
  ...
  _createClass(CalendarJulian, [{
    ...
    value: function fromJD(jd) {
      ...
      var year = _M$JDToCalendarJulian.year;
      var month = _M$JDToCalendarJulian.month;
      var day = _M$JDToCalendarJulian.day;
...
var CalendarGregorian = function (_Calendar2) {
  ...
  function CalendarGregorian() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(CalendarGregorian).apply(this, arguments));
  }
  ...
  _createClass(CalendarGregorian, [{
    ...
    value: function fromJD(jd) {
      ...
      var year = _M$JDToCalendarGregor.year;
      var month = _M$JDToCalendarGregor.month;
      var day = _M$JDToCalendarGregor.day;
...
M.JDToCalendar = function (jd, isJulian) {
  var _base$modf13 = base.modf(jd + 0.5);

  var _base$modf14 = _slicedToArray(_base$modf13, 2);

  var z = _base$modf14[0];
  var f = _base$modf14[1];
...
M.DayOfYearToCalendarGregorian = function (year, n) {
  ...
  var month = _M$DayOfYearToCalenda.month;
  var day = _M$DayOfYearToCalenda.day;
...
M.DayOfYearToCalendarJulian = function (year, n) {
  ...
  var month = _M$DayOfYearToCalenda2.month;
  var day = _M$DayOfYearToCalenda2.day;
