...
M.position = function (planet, earth, jde) {
  ...
  var L0 = posEarth.lon;
  var B0 = posEarth.lat;
  var R0 = posEarth.range;

  var _base$sincos = base.sincos(B0);

  var _base$sincos2 = _slicedToArray(_base$sincos, 2);

  var sB0 = _base$sincos2[0];
  var cB0 = _base$sincos2[1];

  var _base$sincos3 = base.sincos(L0);

  var _base$sincos4 = _slicedToArray(_base$sincos3, 2);

  var sL0 = _base$sincos4[0];
  var cL0 = _base$sincos4[1];


  function pos() {
    var τ = arguments.length <= 0 || arguments[0] === undefined ? 0 : arguments[0];
    ...
    var sL = _base$sincos8[0];
    var cL = _base$sincos8[1];
  ...
  var _apparent$eclipticAbe2 = _slicedToArray(_apparent$eclipticAbe, 2);

  var Δλ = _apparent$eclipticAbe2[0];
  var Δβ = _apparent$eclipticAbe2[1];
  ...
  */
  ...
  _createClass(Elements, [{
    ...
    value: function position(jde, earth) {
      ...
      var sΩ = _base$sincos10[0];
      var cΩ = _base$sincos10[1];
