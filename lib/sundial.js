...
M.general = function (φ, D, a, z) {
  ...
  var sφ = _base$sincos2[0];
  var cφ = _base$sincos2[1];
  ...
  var sD = _base$sincos4[0];
  var cD = _base$sincos4[1];

  var _base$sincos5 = base.sincos(z);

  var _base$sincos6 = _slicedToArray(_base$sincos5, 2);

  var sz = _base$sincos6[0];
  var cz = _base$sincos6[1];
  ...
  for (var i = 0; i < 24; i++) {
    ...
    var sH = _base$sincos8[0];
    var cH = _base$sincos8[1];
...
M.horizontal = function (φ, a) {
  ...
  var sφ = _base$sincos12[0];
  var cφ = _base$sincos12[1];
...
M.vertical = function (φ, D, a) {
  ...
  for (var i = 0; i < 24; i++) {
    ...
    var sH = _base$sincos20[0];
    var cH = _base$sincos20[1];
