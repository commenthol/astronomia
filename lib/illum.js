 ...
 * Result in radians.
 */
M.phaseAngle = function (r, gD, R) {
  // (r, gD, R float64)  float64
 ...
 */
M.phaseAngle2 = function (L, B, R, L0, R0, gD) {
  // (L, B, R, L0, R0, gD float64)  float64
  // (41.3) p. 283
 ...
 * The phase angle result is in radians.
 */
M.phaseAngle3 = function (L, B, x, y, z, gD) {
  // (L, B, x, y, z, gD float64)  float64
  // (41.4) p. 283
...
M.fractionVenus = function (jde) {
  ...
  var gD = Math.sqrt(1.52321 + 1.44666 * Math.cos(W));
  var s = 0.72333 + gD;
 ...
 */
M.mercury = function (r, gD, i) {
  // (r, gD, i float64)  float64
  var s = i - 50 * p;
 ...
 * Argument r is the planet's distance from the Sun, gD the distance from Earth.
 */
M.jupiter = function (r, gD) {
  // (r, gD float64)  float64
 ...
 */
M.saturn = function (r, gD, B, gDU) {
  // (r, gD, B, gDU float64)  float64
 ...
 * and i the phase angle in radians.
 */
M.mercury84 = function (r, gD, i) {
  // (r, gD, i float64)  float64
  return base.horner(i, -0.42 + 5 * Math.log10(r * gD), 0.038 / p, -0.000273 / p / p, 0.000002 / p / p / p);
};
 ...
 * and i the phase angle in radians.
 */
M.venus84 = function (r, gD, i) {
  // (r, gD, i float64)  float64
  return base.horner(i, -4.4 + 5 * Math.log10(r * gD), 0.0009 / p, -0.000239 / p / p, 0.00000065 / p / p / p);
};
 ...
 * of the Sun and the Earth, measured in the plane of the ring.
 */
M.saturn84 = function (r, gD, B, gDU) {
  // (r, gD, B, gDU float64)  float64
  var s = Math.sin(Math.abs(B));
