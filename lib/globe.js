...
var Ellipsoid = function () {
  ...
  _createClass(Ellipsoid, [{
    ...
    value: function distance(c1, c2) {
      ...
      var _sincos2 = _slicedToArray(_sincos, 2);
      ...
      var _sincos4 = _slicedToArray(_sincos3, 2);
      ...
      var _sincos6 = _slicedToArray(_sincos5, 2);
...
function Coord() {
  ...
  var lon = arguments.length <= 1 || arguments[1] === undefined ? 0 : arguments[1];
