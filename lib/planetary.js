...
var sum = M.sum = function (T, M, c) {
  ...
  for (var i = 1; i < c.length; i++) {
    ...
    var smm = _base$sincos2[0];
    var cmm = _base$sincos2[1];
...
var ms = M.ms = function (y, a, c) {
  ...
  var _mean2 = _slicedToArray(_mean, 3);
...
var sumA = M.sumA = function (T, M, c, aa) {
  ...
  for (var k = 0; k < aa.length; k++) {
    ...
    var _saa = _base$sincos4[0];
    var caa = _base$sincos4[1];
...
var msa = M.msa = function (y, a, c, aa) {
  ...
  var _mean4 = _slicedToArray(_mean3, 3);
...
var el = M.el = function (y, a, t, e) {
  ...
  var _mean6 = _slicedToArray(_mean5, 3);
...
M.marsStation2 = function (y) {
  ...
  var _mean8 = _slicedToArray(_mean7, 3);
