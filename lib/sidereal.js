...
function _mean(jd) {
  ...
  var _mean0UT3 = _slicedToArray(_mean0UT2, 2);
...
M.mean0UT = function (jd /* float */) {
  ...
  var _mean0UT5 = _slicedToArray(_mean0UT4, 2);

  var s = _mean0UT5[0];
  var _ = _mean0UT5[1]; // eslint-disable-line
...
function _mean0UT(jd /* float */) {
  ...
  var _M$JDToCFrac2 = _slicedToArray(_M$JDToCFrac, 2);

  var cen = _M$JDToCFrac2[0];
  var f = _M$JDToCFrac2[1];
  // (12.2) p. 87
