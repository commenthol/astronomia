...
M.nutation = function (jde) {
  ...
  var gw = base.horner(T, 125.04452, -1934.136261, 0.0020708, 1.0 / 450000) * Math.PI / 180;
  var gDgps = 0;
  var gDge = 0;
...
M.approxNutation = function (jde) {
  ...
  var _base$sincos3 = base.sincos(gw),
  ...
  var _base$sincos9 = base.sincos(2 * gw),
      _base$sincos10 = _slicedToArray(_base$sincos9, 2),
      s2gw = _base$sincos10[0],
      c2gw = _base$sincos10[1];
...
var table22A = function () {
  var PROPS = 'd,m,n,f,gwa,s0,s1,c0,c1'.split(',');
