...
M.nutation = function (jde) {
  ...
  for (var i = table22A.length - 1; i >= 0; i--) {
    ...
    var s = _base$sincos2[0];
    var c = _base$sincos2[1];
...
M.approxNutation = function (jde) {
  ...
  var sΩ = _base$sincos4[0];
  var cΩ = _base$sincos4[1];

  var _base$sincos5 = base.sincos(2 * L);

  var _base$sincos6 = _slicedToArray(_base$sincos5, 2);

  var s2L = _base$sincos6[0];
  var c2L = _base$sincos6[1];
  ...
  var s2Ω = _base$sincos10[0];
  var c2Ω = _base$sincos10[1];
...
M.nutationInRA = function (jde) {
  ...
  var Δψ = _M$nutation2[0];
  var Δε = _M$nutation2[1];
