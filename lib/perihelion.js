...
var ap2 = function ap2(p, y, d, v, a, f, cb) {
  ...
  if (cb) {
    ...
    var _ap2a2 = _slicedToArray(_ap2a, 2);
    ...
    var _ap2a4 = _slicedToArray(_ap2a3, 2);
...
var ap2a = function ap2a(j1, d, a, v, cb) {
  ...
  function end() {
    ...
    var _l$extremum2 = _slicedToArray(_l$extremum, 2);

    var jde = _l$extremum2[0];
    var r = _l$extremum2[1];
