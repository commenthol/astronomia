...
M.positions = function (jde, earth, saturn) {
  ...
  var ss = _base$sincos2[0];
  var cs = _base$sincos2[1];
  ...
  var f = function f() {
    ...
    var lon = _saturn$position.lon;
    var lat = _saturn$position.lat;
    var range = _saturn$position.range;
    ...
    var sl = _base$sincos4[0];
    var cl = _base$sincos4[1];

    var _base$sincos5 = base.sincos(b);

    var _base$sincos6 = _slicedToArray(_base$sincos5, 2);

    var sb = _base$sincos6[0];
    var cb = _base$sincos6[1];
  ...
  var sλ0 = _base$sincos14[0];
  var cλ0 = _base$sincos14[1];

  var _base$sincos15 = base.sincos(β0);

  var _base$sincos16 = _slicedToArray(_base$sincos15, 2);

  var sβ0 = _base$sincos16[0];
  var cβ0 = _base$sincos16[1];
  ...
  var sD = _base$sincos18[0];
  var cD = _base$sincos18[1];
...
Qs.prototype.rhea = function () {
  ...
  var spʹ = _base$sincos20[0];
  var cpʹ = _base$sincos20[1];
  ...
  var sN = _base$sincos22[0];
  var cN = _base$sincos22[1];
...
Qs.prototype.subr = function (λʹ, p, e, a, Ω, i) {
  ...
  var si = _base$sincos24[0];
  var ci = _base$sincos24[1];

  var _base$sincos25 = base.sincos(g);

  var _base$sincos26 = _slicedToArray(_base$sincos25, 2);

  var sg = _base$sincos26[0];
  var cg = _base$sincos26[1];
...
Qs.prototype.titan = function () {
  ...
  var siʹ = _base$sincos28[0];
  var ciʹ = _base$sincos28[1];

  var _base$sincos29 = base.sincos(Ωʹ - this.W8);

  var _base$sincos30 = _slicedToArray(_base$sincos29, 2);

  var sΩʹW8 = _base$sincos30[0];
  var cΩʹW8 = _base$sincos30[1];
  ...
  var s2g0 = _base$sincos32[0];
  var c2g0 = _base$sincos32[1];
  ...
  var sq = _base$sincos34[0];
  var cq = _base$sincos34[1];
  ...
  var su = _base$sincos36[0];
  var cu = _base$sincos36[1];
