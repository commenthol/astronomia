...
M.position = function (jde) {
  ...
  var e2 = e * e;
  var gSl = 3958 * sin(a1) + 1962 * sin(l_ - f) + 318 * sin(a2);
  var gSr = 0.0;
  var gSb = -2235 * sin(l_) + 382 * sin(a3) + 175 * sin(a1 - f) + 175 * sin(a1 + f) + 127 * sin(l_ - m_) - 115 * sin(l_ + m_);
  ...
  var lon = base.pmod(l_, 2 * Math.PI) + gSl * 1e-6 * D2R;
  var lat = gSb * 1e-6 * D2R;
  var range = 385000.56 + gSr * 1e-3;
...
var ta = function () {
  ...
  return ta.map(function (row) {
    var o = {};['d', 'm', 'm_', 'f', 'gSl', 'gSr'].map(function (D2R, i) {
      o[D2R] = row[i];
    });
    return o;
  });
...
var tb = function () {
  ...
  return tb.map(function (row) {
    var o = {};['d', 'm', 'm_', 'f', 'gSb'].map(function (D2R, i) {
      o[D2R] = row[i];
    });
    return o;
  });
